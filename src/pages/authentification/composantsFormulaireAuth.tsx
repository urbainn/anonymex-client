...
export function AuthFormulaire(
    { onSubmit, children }: { onSubmit: (e: React.FormEvent<HTMLFormElement>) => void; type?: 'login' | 'signup'; children: React.ReactNode }
) {
    return (
...
export function AuthFormCorps(
    { title, description, children }: { title: string; description?: string; children: React.ReactNode; type?: 'login' | 'signup' }
) {
    return (
        <Box padding={5}>
